...
class _HandwritingBlankPageState extends State<HandwritingBlankPage> with WindowListener {
  ...
  void _createFile(String path) async {
    ...
    fileTreeManager.addFile(
        DrawingBoardFileConfig.fromDrawingBoardFile(_drawingBoardFile),
        directoryPath: path);
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 1),
                            Text(
                                "${_penWidth.toStringAsFixed(1)}"), //保留一位小数
                          ],
                        ),
                        SizedBox(height: 15),
                        Row(
  ...
  void _loadFile(String filePath) async {
    ...
    _drawingBoardFile = DrawingBoardFile.fromMap(
